...
type ServiceMock struct {
	...
	GenerateFirebaseDeeplinkWithMetaFn func(link string, title string, description string, previewThumbnail string) (string, error)
}
...
func (m ServiceMock) GenerateFirebaseDeeplinkWithMeta(link string, title string, description string, previewThumbnail string) (string, error) {
	return m.GenerateFirebaseDeeplinkWithMetaFn(link, title, description, previewThumbnail)
}
