...
func InitListener(appCtx context.Context, configuration boilerplate.KafkaListenerConfiguration,
	...
	return kafka_listener.NewSingleListener(configuration, kafka_listener.NewCommand("push admin messages",
		func(executionData kafka_listener.ExecutionData, request ...kafka.Message) []kafka.Message {
			...
			result, err := process(*mapped, executionData.Context, notificationSender, executionData.ApmTransaction)
