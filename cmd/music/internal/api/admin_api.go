...
func (m *musicApp) initAdminApi() error {
	legacyCommands := []router.ICommand{
		m.playlistsListAdmin(),
		m.upsertPlaylists(),
		m.deletePlaylists(),
		m.addSongToPlaylistAdmin(),
		m.deleteSongFromPlaylistAdmin(),
		m.playlistSongListAdmin(),
		m.allSongsListAdmin(),
		m.ownStorageMusicList(),
		m.upsertSongsToOwnStorage(),
		m.deleteSongsFromOwnStorage(),
	}

	for _, command := range legacyCommands {
		if err := m.httpRouter.GetRpcAdminEndpoint().RegisterRpcCommand(command); err != nil {
			return err
		}
	}
	return nil
...
func (m *musicApp) upsertPlaylists() router.ICommand {
	...
	return router.NewAdminCommand(method, func(request []byte, executionData router.MethodExecutionData) (interface{}, *error_codes.ErrorWithCode) {
		...
		return res, nil
	}, common.AccessLevelWrite, "music:playlist:upsert")
}
...
func (m *musicApp) deletePlaylists() router.ICommand {
	...
	return router.NewAdminCommand(method, func(request []byte, executionData router.MethodExecutionData) (interface{}, *error_codes.ErrorWithCode) {
		...
		return "ok", nil
	}, common.AccessLevelWrite, "music:playlist:delete")
}
...
func (m *musicApp) playlistsListAdmin() router.ICommand {
	...
	return router.NewAdminCommand(method, func(request []byte, executionData router.MethodExecutionData) (interface{}, *error_codes.ErrorWithCode) {
		...
		return resp, nil
	}, common.AccessLevelRead, "music:playlist:list")
}
...
func (m *musicApp) addSongToPlaylistAdmin() router.ICommand {
	...
	return router.NewAdminCommand(method, func(request []byte, executionData router.MethodExecutionData) (interface{}, *error_codes.ErrorWithCode) {
		...
		return "ok", nil
	}, common.AccessLevelWrite, "music:playlist:song:add")
}
...
func (m *musicApp) deleteSongFromPlaylistAdmin() router.ICommand {
	...
	return router.NewAdminCommand(method, func(request []byte, executionData router.MethodExecutionData) (interface{}, *error_codes.ErrorWithCode) {
		...
		return "ok", nil
	}, common.AccessLevelWrite, "music:playlist:song:delete")
}
...
func (m *musicApp) playlistSongListAdmin() router.ICommand {
	...
	return router.NewAdminCommand(method, func(request []byte, executionData router.MethodExecutionData) (interface{}, *error_codes.ErrorWithCode) {
		...
		return resp, nil
	}, common.AccessLevelWrite, "music:playlist:song:list")
}
...
func (m *musicApp) allSongsListAdmin() router.ICommand {
	...
	return router.NewAdminCommand(method, func(request []byte, executionData router.MethodExecutionData) (interface{}, *error_codes.ErrorWithCode) {
		...
		return resp, nil
	}, common.AccessLevelWrite, "music:list")
}
...
func (m *musicApp) upsertSongsToOwnStorage() router.ICommand {
	...
	return router.NewAdminCommand(method, func(request []byte, executionData router.MethodExecutionData) (interface{}, *error_codes.ErrorWithCode) {
		...
		return resp, nil
	}, common.AccessLevelWrite, "music:own_storage:upsert")
}
...
func (m *musicApp) deleteSongsFromOwnStorage() router.ICommand {
	...
	}, common.AccessLevelWrite, "music:own_storage:delete")
}
...
func (m *musicApp) ownStorageMusicList() router.ICommand {
	...
	return router.NewAdminCommand(method, func(request []byte, executionData router.MethodExecutionData) (interface{}, *error_codes.ErrorWithCode) {
		...
		return resp, nil
	}, common.AccessLevelRead, "music:own_storage:list")
}
