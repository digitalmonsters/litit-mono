...
type LikeWrapperMock struct {
	...
	GetInternalUserLikesFn   func(userId int64, size int, page []byte, apmTransaction *apm.Transaction, forceLog bool) chan GetInternalUserLikesResponseChan
}
...
func (w *LikeWrapperMock) GetInternalUserLikes(userId int64, size int, page []byte, apmTransaction *apm.Transaction, forceLog bool) chan GetInternalUserLikesResponseChan {
	return w.GetInternalUserLikesFn(userId, size, page, apmTransaction, forceLog)
}
