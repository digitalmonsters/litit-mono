...
type ContentWrapperMock struct {
	...
	GetTopNotFollowingUsersFn func(userId int64, limit int, apmTransaction *apm.Transaction, forceLog bool) chan GetTopNotFollowingUsersResponseChan
}
...
func (w *ContentWrapperMock) GetTopNotFollowingUsers(userId int64, limit int, apmTransaction *apm.Transaction, forceLog bool) chan GetTopNotFollowingUsersResponseChan {
	return w.GetTopNotFollowingUsersFn(userId, limit, apmTransaction, forceLog)
}
