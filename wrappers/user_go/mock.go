...
func (m *UserGoWrapperMock) GetFriendListData(suggested bool, userId int64, ctx context.Context, forceLog bool) chan wrappers.GenericResponseChan[GetFriendListDataResponse] {
	panic("implement me")
}
...
func (m *UserGoWrapperMock) GetIsRequested(userId int64, ctx context.Context, forceLog bool) chan wrappers.GenericResponseChan[GetFriendListDataResponse] {
	panic("implement me")
}

func (m *UserGoWrapperMock) GetUserRelations(userId int64, ctx context.Context, forceLog bool) chan wrappers.GenericResponseChan[UserRelationData] {
	panic("implement me")
}
