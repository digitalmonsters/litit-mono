...
func (l *loveCounter) Init(subAppLogger zerolog.Logger) error {
	l.logger = subAppLogger
	service := newLoveCounterService(l.kafkaConfig.WorkerPoolSize)

	l.listener = kafka_listener.NewBatchListener(l.kafkaConfig.Kafka, kafka_listener.NewCommand("love_counter_service",
...
func (l loveCounter) Name() string {
	return l.name
}

func (l loveCounter) Close() error {
